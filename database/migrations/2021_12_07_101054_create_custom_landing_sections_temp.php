...
class CreateCustomLandingSectionsTemp extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('custom_landing_sections_temp', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('custom_landing_sections_temp');
    }
}
