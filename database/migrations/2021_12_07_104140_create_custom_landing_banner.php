...
class CreateCustomLandingBanner extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('custom_landing_banner', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('custom_landing_banner');
    }
}
