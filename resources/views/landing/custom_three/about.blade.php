            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="right-content">
                    <h2 class="wow animate__fadeInUp"
                        ...
                        <p class="wow animate__fadeInUp" data-wow-duration="500ms">{{$section_parent->section_description}}</p>
                        <p class="wow animate__fadeInUp" data-wow-duration="500ms">{{$section_data[0]->long_description}}</p>
