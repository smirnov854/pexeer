        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav user-management-nav profile-nav mb-3" id="pills-tab" role="tablist">
                    ...
                    <li>
                        <a onclick="datatableReload()" class=" @if(isset($tab) && $tab=='edit_profile') active @endif nav-link  " data-id="edit_profile" data-toggle="pill" role="tab" data-controls="edit_profile" aria-selected="true" href="#edit_profile">
                            ...
                            <div class="table-area">
                                <div class="">
                                    <table id="deposit_table" class="table table-borderless custom-table display text-center"
                                        ...
                                        <tr>
                                            <th class="">{{__('Type')}}</th>
                                            <th class="">{{__('Sender')}}</th>
                                            <th class="">{{__('Address')}}</th>
                                            <th class="">{{__('Receiver')}}</th>
                                            <th class="">{{__('Amount')}}</th>
                                            <th class="">{{__('Coin Type')}}</th>
                                            <th class="">{{__('Fees')}}</th>
                                            <th class="">{{__('Transaction Id')}}</th>
                                            <th class="">{{__('Status')}}</th>
                                            <th class="">{{__('Created Date')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
...
@section('script')
    <script>
        ...
        function datatableReload() {
            if (!$('.mystyle').length) {
                var element = document.getElementById("withdrawal_table");
