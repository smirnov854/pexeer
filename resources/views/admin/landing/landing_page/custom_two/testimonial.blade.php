...
<section class="testimonial-two-area section section-bg-two" id="testimonial">
    <div class="container">
        <div class="section-title text-center mb-55">
            <h2 class="title section-title-testimonial-main">{{$section_parent->section_title}}</h2>
            <span class="devider"></span>
            <p class="sub-title section-subtitle-testimonial-main">{{$section_parent->section_description}}</p>
        </div>
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="testimonial-slide-two testimonial-details-container">
