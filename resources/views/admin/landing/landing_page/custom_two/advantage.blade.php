<section class="cash-crypto-today section-top pb-90">
    <div class="container">
        <div class="section-title text-center mb-55">
            <h2 class="title advantage-title">{{$section_parent->section_title}}</h2>
            <span class="devider"></span>
            <p class="sub-title advantage-sub-title">{{$section_parent->section_description}}</p>
        </div>
        <div class="row advantage-details-container">
