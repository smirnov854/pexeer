<section class="team-area{{$element_prefix}} section-top pb-90">
    <div class="container">
        <div class="section-title text-center mb-55">
            <h2 class="title section-title-team-main">{{$section_parent->section_title}}</h2>
            <span class="devider"></span>
            <p class="sub-title section-subtitle-team-main">{{$section_parent->section_description}}</p>
        </div>
