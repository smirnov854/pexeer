<section class="how-to-trade-area section" id="how-to-trade">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-header-area text-center">
                    <h2 class="section-title coin-section-title">{{$section_parent->section_title}}</h2>
                    <p class="section-subtitle coin-section-subtitle">{{$section_parent->section_description}}</p>
                </div>
            </div>
        </div>
        ...
        <div class="marketplace-button mt-20 text-center">
            <a href="{{url('exchange')}}" class="primary-btn btn-lg">{{__('Go to Marketplace')}}<i class="fas fa-angle-right"></i></a>
        </div>
    </div>
</section>
