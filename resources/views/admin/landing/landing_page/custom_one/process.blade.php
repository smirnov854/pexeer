        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-header-area text-center">
                    <h2 class="section-title section-title-process-main">{{$section_parent->section_title}}</h2>
                    <p class="section-subtitle section-subtitle-process-main">{{$section_parent->section_description}}</p>
                </div>
            </div>
        </div>
